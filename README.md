...
# 9. BDD / Teste do Afonso

Teste correspondente ao cenário de média exatamente 7,0:
...
Esse teste garante que o sistema respeite exatamente a regra do estudo de caso:

> a média precisa ser **acima de 7,0**.

Portanto, média igual a 7,0 não libera cursos.

## Evidência — BDD/TDD Afonso

> COLOCA PRINT AQUI

![Evidência Afonso](docs/afonso.png)

---

# 10. BDD / Teste do Giulianno

Teste correspondente ao cenário de média inferior a 7,0:
...
Esse teste garante que alunos com média inferior a 7,0 não recebam os três cursos adicionais.
